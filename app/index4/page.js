...
const page = () => {
  return (
    ...
    >
      {/* Hero area start */}
      <section className="hero-area-four bgc-primary pt-215 rpt-150 pb-100 rel z-1">
      ...
      {/* Counter Area Start */}
      <section className="counter-area-four bgc-primary rel z-2 pt-130 rpt-100">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-9 col-lg-11">
              <div
      ...
      {/* Pricing Area Start */}
      <section className="pricing-area-four bgc-lighter overflow-hidden rel z-1 pt-125 rpt-95 pb-100 rpb-70">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-7 col-lg-9 col-md-11">
              <div
